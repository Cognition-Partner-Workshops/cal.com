...
export default function Login({
  ...
  return (
    <div className="text-emphasis min-h-screen [--cal-brand-emphasis:#1e40af] [--cal-brand-subtle:#93c5fd] [--cal-brand-text:white] [--cal-brand:#2563eb] dark:[--cal-brand-emphasis:#93c5fd] dark:[--cal-brand-text:white] dark:[--cal-brand:#1d4ed8]">
      <AuthContainer
        showLogo
