  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Rates for {rateData.location}</h2>
        ...
        <div className="hidden rounded-lg bg-blue-50 px-4 py-2 sm:block">
      ...
      <div className="mt-8 rounded-lg bg-gray-100 p-4 text-xs leading-relaxed text-gray-500">
